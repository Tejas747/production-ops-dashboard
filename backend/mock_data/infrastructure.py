...
def get_infrastructure_data():
    ...
    def get_dependency_graph():
        services = [
        {"id": "browser",        "label": "Browser / Mobile", "x": 300, "y": 20,  "tier": "client"},
        {"id": "cdn",            "label": "CDN",              "x": 520, "y": 20,  "tier": "client"},
        {"id": "api_gateway",    "label": "API Gateway",      "x": 300, "y": 100, "tier": "gateway"},
        {"id": "auth",           "label": "Auth Service",     "x": 100, "y": 190, "tier": "core"},
        {"id": "user",           "label": "User Service",     "x": 240, "y": 190, "tier": "core"},
        {"id": "order",          "label": "Order Service",    "x": 380, "y": 190, "tier": "core"},
        {"id": "payment",        "label": "Payment Service",  "x": 520, "y": 190, "tier": "core"},
        {"id": "inventory",      "label": "Inventory",        "x": 60,  "y": 290, "tier": "support"},
        {"id": "notification",   "label": "Notification",     "x": 180, "y": 290, "tier": "support"},
        {"id": "search",         "label": "Search Service",   "x": 300, "y": 290, "tier": "support"},
        {"id": "recommendation", "label": "Recommend",        "x": 420, "y": 290, "tier": "support"},
        {"id": "shipping",       "label": "Shipping",         "x": 540, "y": 290, "tier": "support"},
        {"id": "analytics",      "label": "Analytics",        "x": 60,  "y": 390, "tier": "data"},
        {"id": "cart",           "label": "Cart Service",     "x": 180, "y": 390, "tier": "data"},
        {"id": "product",        "label": "Product Service",  "x": 300, "y": 390, "tier": "data"},
        {"id": "review",         "label": "Review Service",   "x": 420, "y": 390, "tier": "data"},
        {"id": "email",          "label": "Email Service",    "x": 540, "y": 390, "tier": "data"},
        {"id": "kafka",          "label": "Kafka",            "x": 180, "y": 490, "tier": "infra"},
        {"id": "postgres",       "label": "PostgreSQL",       "x": 340, "y": 490, "tier": "infra"},
        {"id": "redis",          "label": "Redis",            "x": 500, "y": 490, "tier": "infra"},
    ]
